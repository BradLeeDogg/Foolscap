...
const COMMANDS: Cmd[] = [
  ...
  { id: 'save-now', label: 'Save now + snapshot', hint: 'Ctrl/⌘ S' },
  { id: 'panel-inspector', label: 'Inspector', hint: 'Ctrl/⌘ ⇧ I' },
  { id: 'panel-sources', label: 'Sources', hint: 'Ctrl/⌘ ⇧ R' },
  { id: 'panel-factcheck', label: 'Fact-check', hint: 'Ctrl/⌘ ⇧ F' },
